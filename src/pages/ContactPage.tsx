          ...
          <div className="grid lg:grid-cols-2 gap-12">
              ...
              <Card className="p-8 border-border shadow-lg">
                <form className="space-y-6">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        placeholder="John"
                        required
                        className="rounded-lg border-border bg-[var(--color-primary-100)]/30 focus:border-[var(--color-primary-400)] focus:ring-[var(--color-primary-400)]"
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      id="service"
                      className="w-full rounded-lg border-border bg-[var(--color-primary-100)]/30 focus:border-[var(--color-primary-400)] focus:ring-[var(--color-primary-400)] px-3 py-2"
                    >
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea 
                      ...
                      rows={5}
                      required
                      className="rounded-lg border-border bg-[var(--color-primary-100)]/30 focus:border-[var(--color-primary-400)] focus:ring-[var(--color-primary-400)] resize-none"
                    />
                  </div>
            ...
            <div>
              ...
              <div className="space-y-6 mb-12">
                <Card className="p-6 border-border hover:border-[var(--color-primary-400)]/30 transition-colors">
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[var(--color-primary-400)]/10 to-accent/10 flex items-center justify-center shrink-0">
                      <Mail className="w-6 h-6 text-primary" />
                    </div>
                    <div>
                      <h4 className="text-foreground mb-1">Email</h4>
                      <a href="mailto:hello@sagestoneinc.com" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <Card className="p-6 border-border hover:border-[var(--color-primary-400)]/30 transition-colors">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+12149452234" className="text-muted-foreground hover:text-primary transition-colors">
                        +1 (214) 945-2234
                      </a>
                      <p className="text-sm text-muted-foreground mt-1">
                ...
                <Card className="p-6 border-border hover:border-[var(--color-primary-400)]/30 transition-colors">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground mb-1">Schedule a Call</h4>
                ...
                <Card className="p-6 border-border hover:border-[var(--color-primary-400)]/30 transition-colors">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-foreground mb-1">Response Time</h4>
              ...
              <div className="bg-muted rounded-2xl p-8 border border-border">
                <h4 className="text-foreground mb-4">Looking for something specific?</h4>
                <div className="space-y-3">
                  <button 
                    onClick={() => onNavigate("services")}
                    className="w-full flex items-center justify-between text-muted-foreground hover:text-primary transition-colors"
                  >
